...
class Ui_MusicPlayer(object):
    def setupUi(self, MusicPlayer):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/files.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/media-playback-stop.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
