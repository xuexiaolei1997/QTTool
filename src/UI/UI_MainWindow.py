...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidget_Left.setMinimumSize(QtCore.QSize(200, 161))
        ...
        self.toolBox = QtWidgets.QToolBox(self.dockWidget_Resource)
        self.toolBox.setObjectName("toolBox")
        self.FileTree = QtWidgets.QWidget()
        self.FileTree.setGeometry(QtCore.QRect(0, 0, 182, 623))
        self.FileTree.setObjectName("FileTree")
        self.toolBox.addItem(self.FileTree, "")
        self.Considering = QtWidgets.QWidget()
        self.Considering.setGeometry(QtCore.QRect(0, 0, 182, 623))
        self.Considering.setObjectName("Considering")
        self.toolBox.addItem(self.Considering, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.FileTree), _translate("MainWindow", "Page 1"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.Considering), _translate("MainWindow", "Page 2"))
